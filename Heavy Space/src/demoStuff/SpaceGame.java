...
import demoStuff.WavefrontMeshLoader.Mesh;
...
public class SpaceGame {
    ...
    private static int createShader(String resource, int type) throws IOException {
        ...
        ByteBuffer source = DemoUtils.ioResourceToByteBuffer(resource, 1024);
    ...
    private void createCubemapTexture() throws IOException {
        ...
        for (int i = 0; i < 6; i++) {
        	System.out.println("res/models/skyboxes/space/" + names[i] + ".png");
            imageBuffer = DemoUtils.ioResourceToByteBuffer("res/models/skyboxes/space/" + names[i] + ".png", 8 * 1024);
